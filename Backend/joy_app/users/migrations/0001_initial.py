    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_surname', models.CharField(max_length=150, unique=True, verbose_name='Name')),
                ('address', models.CharField(max_length=150, unique=True, verbose_name='Address')),
                ('id_number', models.DecimalField(decimal_places=0, max_digits=30, primary_key=True, serialize=False, unique=True)),
