# Generated by Django 4.1.4 on 2023-02-16 18:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('validity', models.CharField(max_length=100, verbose_name='validity')),
                ...
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='licenses2', to=settings.AUTH_USER_MODEL, verbose_name='creator2')),
            ],
            options={
